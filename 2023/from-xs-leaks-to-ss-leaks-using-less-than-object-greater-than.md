...
The above technique is great, but it relies on our HTML injection being within the user's viewport! If the injection is not visible to the user (which happens quite a lot), can we still leak data?
